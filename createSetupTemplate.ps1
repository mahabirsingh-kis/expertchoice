Clear-Host
Remove-Module ComparionMod
Import-Module .\ComparionMod.psm1

#read from Setup.ini
$INI = Get-IniContent setup.ini
$outFile = 'setup.ini.template'
Remove-Item $outFile -ErrorAction Ignore
$sections = 'setup','sign','azure'
foreach($sec in $sections)
{
    $keys = $INI[$sec].Keys | Sort-Object
    Add-Content $outFile $('['+$sec+']')
    foreach($v in $keys)
    {
      Add-Content $outFile $v'=%'$v'%'
    }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUNxFgtEN0cNn4U2K5nG9eAdtF
# ePigghQlMIIEfTCCA2WgAwIBAgIDG+cVMA0GCSqGSIb3DQEBCwUAMGMxCzAJBgNV
...
# hkiG9w0BCQQxFgQUONYt49PJhhBhpPxwZYfQhm5xSdUwDQYJKoZIhvcNAQEBBQAE
# ggIAFGkbQ7UlC24DlGQmLVVj9C4V7uGt0HctwVD2E5n5CGXVYixMPeWSEOm/UTL7
# kXqLKKgGHd3OAxU2neUMLJyiYJuL6CQ6HCbZPl8F7Yu0VDj17ohXJeWQIwBsvUYF
# StPdf6HQgolCNUQtLGPHRW0i4nYzUrWafWsMUdQ3fvH2CBaSDrhvlWWjHupWhw2T
# v8588FQQKjRmLZkzalOKqmpizCC0LOl/a/dDmU6gkj5ssOBp6XyFTd2nqghUV2co
# V041XX+NvXLSJ3EFrG5sGI+/aHXDReMXDrdUW2O58EHDbPLgzYzQ/g1U9wYWNyvD
# VLHWfFrtGDuQ3HWXvR9IkkXPDVZKn0inTTz+VLPUc8EQPJcBo32FoEfWc8Qb/ggZ
# ZmelOO7QuBKDHB7Weo7jOwenMLVYfPf+dVsIBCbjKxrPPUOzcP6yOfGRzwlYe89K
# kqAjbO1DFsrQLZKd9jCO7D+DhVImNdbpNZ5YjjYRrJmLJJlZo7xBqzU9EcWZwpCO
# 0ankW75PxCVjMvn1exMZyMF3qSBkWGpZmI0iOV33WExM/L1POoCS7cahfYPU7jL8
# cxIAp70jb7ro7QYqmRLDraHF8BSUBr26zkqNQSzur4icfXWWx6E4XRGTiWE0M/5o
# iHVZpkVQylfJHbZ6tmShYVHxHdpPeUkFi3FZAt5ISwHI+RyhggJDMIICPwYJKoZI
...
# BTEPFw0xODEyMjIxODA2MzFaMCMGCSqGSIb3DQEJBDEWBBTx8sXmKxIlGZu+PyPa
# /ZK/AuGVxjANBgkqhkiG9w0BAQEFAASCAQBWb9W4wI5N+e8c3SjJ+eAhGTQQBkID
# MQOKylLwhyNGuSaLrZkZsgw/P0rSAw5+mqhQWx9UH/yHzB3QhW248+cs4UdZJs0F
# UieodyR7JdgM4bUFLsQ9/UkZ7Fiov8A/y+7+lLQYqTBkxKAl75+ywQlcjepk4UHt
# Ym+xi95LJwg6tTxCEz9h2En0hLPkw6SFF8juxafuf1DVvw8GDpZnXpricDd/UCyY
# YuIo4H6P6eflXhIn/YsR0bF9f5hT657KrUARM8ixlheTZMglJ6sBP/ANRoFRxXp1
# ukf/ug1CmmgXqxt/kQ/h0IvXuYy5COnTJv4AeSsnFt3MsZ1vdbuNAVTC
