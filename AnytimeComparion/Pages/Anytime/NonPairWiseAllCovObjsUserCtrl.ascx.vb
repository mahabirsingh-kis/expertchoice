...
Public Class NonPairWiseAllCovObjsUserCtrl
    ...
    Public Shared Function GetNonPairWiseAllCovObjData(ByRef AnytimeAction As clsAction, ByRef App As clsComparionCore, ByRef StepNode As clsNode)
    ...
    Public Shared Function SetInfoDoc_Params(ByVal NodeID As Guid)
        Dim infodoc_params As String() = New String(4) {}
