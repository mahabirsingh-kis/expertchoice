...
<div class="large-12 columns">
    ...
    <div class="columns tt-accordion-head blue">
        ...
        <span class="text">Rate the preference of <asp:Label ID="alternativeLbl" runat="server"></asp:Label> with respect to 
            <asp:Label ID="objectLbl" runat="server"></asp:Label></span>
    </div>
...
<div class="large-12 columns">
  <div class="tt-judgements-item large-12 columns">
      <div class="columns tt-j-title">
          <h3>
            <% if  (view == "anytime"){ %>Your Judgment<% } %>
            <% if  (view == "teamtime"){ %>Judgments<% } %>
          </h3>
      </div>
 ...
 <div class="row collapse">    
  ...
  <ul class="tt-rating-scale">
    <li><label><input type="radio" name="radioTest"><br>0</label></li>
    <li><label><input type="radio" name="radioTest"><br>1</label></li>
    <li><label><input type="radio" name="radioTest"><br>2</label></li>
    <li><label><input type="radio" name="radioTest"><br>3</label></li>
    <li><label><input type="radio" name="radioTest"><br>4</label></li>
    <li><label><input type="radio" name="radioTest"><br>5</label></li>
    <li><label><input type="radio" name="radioTest"><br>7</label></li>
    <li><label><input type="radio" name="radioTest"><br>6</label></li>
    <li><label><input type="radio" name="radioTest"><br>7</label></li>
    <li><label><input type="radio" name="radioTest"><br>8</label></li>
    <li><label><input type="radio" name="radioTest"><br>9</label></li>
    <li><label><input type="radio" name="radioTest"><br>10</label></li>
  </ul>
  </div>
