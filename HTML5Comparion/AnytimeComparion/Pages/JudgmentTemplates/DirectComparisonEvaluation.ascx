<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DirectComparisonEvaluation.ascx.cs" Inherits="AnytimeComparion.Pages.JudgmentTemplates.DirectComparisonEvaluation" %>
                ...
                <ul class="tt-drag-slider-wrap">
                    ...
                    <li>
                        <div id="2" class="large-12 columns tt-drag-slider-item">
                            ...
                            <div class="medium-2 columns"><a class="dsReset2 ds-res-btn" title="reset judgment selection"><span class="icon-tt-close"></span></a></div>
                        </div>
                    </li>
                    <li>
                        <div id="3" class="large-12 columns tt-drag-slider-item">
                            ...
                            <div class="medium-2 columns"><a class="dsReset3 ds-res-btn" title="reset judgment selection"><span class="icon-tt-close"></span></a></div>
                        </div>
                    </li>
                    <li>
                        <div id="4" class="large-12 columns tt-drag-slider-item">
                            ...
                            <div class="medium-2 columns"><a class="dsReset4 ds-res-btn" title="reset judgment selection"><span class="icon-tt-close"></span></a></div>
                        </div>
                    </li>
                    <li>
                        <div id="5" class="large-12 columns tt-drag-slider-item">
                            ...
                            <div class="medium-2 columns"><a class="dsReset5 ds-res-btn" title="reset judgment selection"><span class="icon-tt-close"></span></a></div>
                        </div>
                    </li>
                    <li>
                        <div id="6" class="large-12 columns tt-drag-slider-item">
                            ...
                            <div class="medium-2 columns"><a class="dsReset6 ds-res-btn" title="reset judgment selection"><span class="icon-tt-close"></span></a></div>
                        </div>
                    </li>
                </ul>
                <% } %>
