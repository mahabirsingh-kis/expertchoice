<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DirectComparisonPriorities.ascx.cs" Inherits="AnytimeComparion.Pages.JudgmentTemplates.DirectComparisonPriorities" %>
