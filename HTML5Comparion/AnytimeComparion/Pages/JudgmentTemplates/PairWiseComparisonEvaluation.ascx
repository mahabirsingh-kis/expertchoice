<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PairWiseComparisonEvaluation.ascx.cs" Inherits="AnytimeComparion.Pages.JudgmentTemplates.PairWiseComparisonEvaluation" %>
