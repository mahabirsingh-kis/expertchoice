...
if ($Testing) {
    "Testing! No files will be deleted`n`n"
}
$start = (Get-Date)
"Start: $start`n"
...
$files = Get-ChildItem $targetDir |
    Where CreationTime -lt (Get-Date).AddDays(-1 * $days) |
#    Where CreationTime -gt (Get-Date).AddMinutes(-1 * $days) |
    Sort-Object -Property LastWriteTime #-Descending

    #Where CreationTime -lt (Get-Date).AddDays(-1 * $days) |
    #Where CreationTime -gt (Get-Date).AddMinutes(-1 * 60)
...
if ($files.CounT -gt 0){
    ...
    "No files found older than $((Get-Date).AddDays(-1 * $days))`n"
}

$finish = (Get-Date)

"Finish: $(Get-Date)`n`nDuration: $($finish-$start)`n`n"

# SIG # Begin signature block
# MIIaZgYJKoZIhvcNAQcCoIIaVzCCGlMCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUZvBWgtyAXo3D9YUQSftDhERs
# XYOgghQlMIIEfTCCA2WgAwIBAgIDG+cVMA0GCSqGSIb3DQEBCwUAMGMxCzAJBgNV
...
# hkiG9w0BCQQxFgQU1j8/UUqgifm9AmVKQSiibBWC9lwwDQYJKoZIhvcNAQEBBQAE
# ggIAJDgy/aAb58WulRW9/oZtUxS7653MBT5T1FTc0K+sqqZskz3LLJaUHi4xG9bQ
# wTmJkjbLXa8RtvCLyeja6uB9l+1Jkxapq+ud1BJipbUM9jJI9Bu5ehVZ9A9Rw+80
# Pu9gUyFBi6HmPqMjGZm3et4qmFfNTmted9grujzAhMurbTCbFSnsTP9xorBDjWw5
# hiTb8f70bL2LpDhDTWLGFxYejCHYMhzWHPXGBeF+aC9WUm4sz2aimKP+x1PNsaHr
# pK4cZBhuHwG1tnXqKTFr8fWD74dPTIa7nLL6RieBgAZdsd0Gr6Ik6u5s3emOT6Nx
# zw2nXcrE4HNo1kHj1gOvhRGWuVVFkJNFws5H973EW5qGRg0URepZNdJX649minKc
# BtD3GtlVKlN1BBslf/Nyg+hKkXMsd3nCY0iPe/n8XRpwb37pNbXiRjX42hZiHouz
# w2fMMBMusAIpgfs3LB0ocK1BistzvBb1oFoCURanQWNTUo7VazZ9T83FMfY4Zezr
# TkUxEwlVRm5JUTJ+pY/rwGL8BDDuG38rNNZpW7ZyeGmi85q7fxtIt7YJT485MGuy
# G2VGE9CPJJcHJCKG1sHWUE2J/OlM7gLA0JGWoziSpcujUv9staM7LqnQzV2I8HBN
# +nnx464OvgWoREhoI6Y8wRvJ7Egt/ItQZxBFqmsrjZvHnLShggJDMIICPwYJKoZI
...
# BTEPFw0xOTAxMDIxNzMxMDNaMCMGCSqGSIb3DQEJBDEWBBS+YEWORLKM4fa2kK7Y
# 2VsnSX7YwTANBgkqhkiG9w0BAQEFAASCAQABmZ5P/3RzEBjvx/adhQ2CSn3+LkJd
# pKuat7Be6mYpyqC3xanDff61e7bqNjzT15DFIGekaRtxf+pqhNJiry9Ktr8W/42y
# NLvVoWkEJvzrFOxGCPPqOrBkPFCz6Jrd6mj64QS1Nxi32pTsBdqUaAxxjG0DnUFJ
# 6TnAUzPGKhnSlpaUfPudkB2TtcZOMyMB8L5Os1jo7SCu4R3y5jJE+fnJXca2l6SU
# I/2g5h0d/GKKKKCZuqMDyVdAvNoUYPhrgy+uzrJcUlFte3UFdfXyR3DmeTgxXftL
# LuTbA8vrwc50qCHa6LCapDgnRowhsMXXVWa1XpkhVIanBn+4UVqhOod9
