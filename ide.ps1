 param (
    [string]$loadIni=".\SelfHostSetup.template.ini")
...
$setupFile = 'setup.ini' 
$success = Test-Path $setupFile

if ($loadIni -ne ""){
    if (!(Test-Path $loadIni)){
        $loadIni = ${env:userprofile}+"\$loadIni"
    }
    if (!(Test-Path $loadIni)){
        Write-Output $loadIni" not found"
        Exit 1
    }
    Write-Output "Copying "$loadIni
...
if($success){
    ...
    $INI.info.CHANGESET=$Changeset
    $INI.info.APPVERSION=$AppVersion
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUFJFBOWYchUQjOvRBLahyUpn3
# +9egghQlMIIEfTCCA2WgAwIBAgIDG+cVMA0GCSqGSIb3DQEBCwUAMGMxCzAJBgNV
...
# hkiG9w0BCQQxFgQU3S1+ZhPVsaWtqptwJhkTYPLTOOYwDQYJKoZIhvcNAQEBBQAE
# ggIAJlJ0X6mVr+RTq2qE7KB1R1H1LL4srmeUcnHKBfx+LbOBxxR8tX4E9Af4SfQg
# SFYJe/DsF6M7Q0btgUB3BDGlXRlOaWtrMc/S1sK4Gb9hTEs0uOvddoiyyy7Av2sB
# CqquyDCZms7Re3UQj53ubqnWY5tP8qSjh5dGW68JcynquAMF59cmhagN7fGSLQJZ
# i3y5tEcwazmquPQ3R1SJDQBk2EtvxIADqsNy9zjRPIJsQ0I9ZGdeWP/VGzv33Y7l
# c5nFXhv88gmTHV28OLcVxGsjIG84bY1O28v8yBV7sAw2sMB/Y3mLsJyIrUaKT4b3
# 5yz5h3IkUxtg3XVeaDOuTsuzPaUDIoDt4GKZqZp8B9KDnBXlnZWe71MRZ7VvJG0J
# cMEQlTu/Gz2iY7arsf+hyc+7t1cW7zg1mP4oTbMVZOCpWDpBFkuIuDky+e1n4syN
# 5RELdlxFhzL9w9KaorTmlSAK/7pxJowIExkh8UEwB7U1tjSoKBaxdE4yWGSuZYJ0
# 8Uon37QeRFJI1vEhv3dP8cC7GfEqn9D34bxfhXkZWzGv30sd7Bjzr68czcPVFDx0
# zuBggJCHzqsB4Z6aW81rucS5oPKFt/b4ottRvClqbm3VWeIpY8/W6fkNrrAzpBMl
# bL5aIwNEWxNTaG7W7bWt4N6SYHk0g97lr4ViitPJU6e0WI+hggJDMIICPwYJKoZI
...
# BTEPFw0xODEyMjIxODA2NDBaMCMGCSqGSIb3DQEJBDEWBBQcjAZ53fB1e2XK8mXJ
# 2TNfv2cxIjANBgkqhkiG9w0BAQEFAASCAQDk059+iJL9U8dzFMy4xBGAJPoRj4NF
# 7xQatOSeHwYMc2R66IaQphoq59Uu4hKJBZbCuR4U2Z4SLV94E43EnyRoxw1EzrUF
# Bpm6uVkQDwvK7UUetDayXKe1pnkZVVauIAWowtr2J3/DxWGNxdQBzQ9BNulxSvsM
# iOxEfW6xR7IXT8p5wT9pHP0f2MKSwm0WK84ip33z0s8RdUC48tIw+zxQ4bo7Dn0B
# UkcVRFtbgZiU7LMmHk642SympOjlWaBi+WHcLNKIrTEXa3eENcPBy7yJKcwDPCJ7
# rQbFiLyvA5wp86mYlQPXWWoammP2Stv4uBSbwtYDhY+iwvMwe4LodpTh
