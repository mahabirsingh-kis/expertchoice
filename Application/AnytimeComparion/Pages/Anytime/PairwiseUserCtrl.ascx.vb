...
Public Class PairwiseUserCtrl
    ...
    Public Shared Function GetPairWiseData(ByRef AnytimeAction As clsAction, ByRef App As clsComparionCore, ByRef StepNode As clsNode, <Out> ByRef Comment As String,
                         ...
                         <Out> ByRef LeftNodeGUID As Guid, <Out> ByRef RightNodeGUID As Guid, <Out> ByRef ParentNodeID As Integer) As Object
        ...
        PWValue = PWData.Value.ToString()
        PWAdvantage = PWData.Advantage.ToString()
        IsUndefined = PWData.IsUndefined.ToString()
