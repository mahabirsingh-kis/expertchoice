Public Class NonPairWiseOneAtATimeUserCtrl
    ...
    Public Shared Function GetNonPairWiseOneAtATimeData(ByRef AnytimeAction As clsAction, ByRef App As clsComparionCore, ByRef StepNode As clsNode) As Object
    ...
    Public Shared Function SetInfoDoc_Params(ByVal ParentNodeID As Guid, ByVal ChildNodeID As Guid) As Object
