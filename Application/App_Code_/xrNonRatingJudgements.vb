...
Public Class xrNonRatingJudgements
    ...
    Private Sub UpdateBinding()
        ...
        'Me.DataSource = ProjectManager.ProjectDataProvider.ReportDataSet(CanvasReportType.crtAllJudgments)
        Me.DataMember = "AltsNonRatingsJudgments"
        Dim grField As GroupField = New GroupField()
        grField.FieldName = "UserName"
        Me.GroupHeader2.GroupFields.Add(grField)

        Me.xrTableCell7.DataBindings.Add("Text", DataSource, "AltsNonRatingsJudgments.UserName")
        Me.xrTableCell2.DataBindings.Add("Text", DataSource, "AltsNonRatingsJudgments.AltName")
        'Me.xrTableCell3.DataBindings.Add("Text", DataSource, "AltsRatingsJudgments.RatingName")
        Me.xrTableCell5.DataBindings.Add("Text", DataSource, "AltsNonRatingsJudgments.Value", "{0:N2}")
        'Me.xrTableCell4.DataBindings.Add("Text", DataSource, "AltsNonRatingsJudgments.Comment") 'L0190
        Me.xrLabel2.DataBindings.Add("Text", DataSource, "AltsNonRatingsJudgments.Comment") 'L0209
...
#Region " Designer generated code "
    ...
    Private Sub InitializeComponent()
        Dim resourceFileName As String = "xrNonRatingJudgements.resx"
        ...
        Me.Detail.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.xrLabel2, Me.xrTable1})
        Me.Detail.Height = 41
        ...
        Me.xrTableCell2.Weight = 0.8584615384615385
        '
        'xrTableCell5
        '
        ...
        Me.xrTableCell5.Weight = 0.14153846153846156
        '
        'xrTable2
        '
...
#End Region
    ...
    Private Sub xrJudgements_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        ...
        dv = ds.Tables("AltsNonRatingsJudgments").DefaultView
