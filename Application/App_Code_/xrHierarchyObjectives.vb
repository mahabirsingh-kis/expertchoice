...
Public Class xrHierarchyObjectives
    ...
    Private Sub UpdateBinding(ByRef PM As clsProjectManager)
        ...
        Me.DataSource = PM.ProjectDataProvider.ReportDataSet(CanvasReportType.crtHierarchyObjectives)
        ...
        Me.xrRichText1.DataBindings.Add("Rtf", DataSource, "HierarchyStructure.Comment") 'L0110
        Me.Margins.Right = 50
...
#End Region
    ...
    Private Sub xrTable1_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles xrTable1.BeforePrint
        ...
        If ReportOptions(0) = "0" Then
            ...
            xrTableCell1.Text = Space(SpaceCount - 1) + xrTableCell1.Text 'L0373
        End If
        'L0101 ==
        ...
        If ARtfText = "" Or ReportOptions(4) = "0" Then 'L0110 'L0122 'L0157
            Me.xrRichText1.Visible = False 'L0110
            Me.xrRichText1.Top = 0 'L0110
            Me.xrRichText1.Height = 0 'L0373
